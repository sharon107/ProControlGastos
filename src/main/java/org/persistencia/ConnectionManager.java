...
public class ConnectionManager { 3 usages
*/
public class ConnectionManager {
     ...
     * - trustServerCertificate=true: Indica que se confie en el certificado del servidor (para entornos de desarrollo).
    ...
    /**
     * Única instancia de la clase JDBC ConnectionManager (para el patrón Singleton).
     * Se inicializa a nul y se crea solo cuando se necesita por primera vez.
     */
    ...
    public void disconnect() throws SQLException {
        ...
        if (this.connection != null) {
            try {
                ...
                // Aqui se asegura que la referencia a la conexión se establezca a null,
     ...
     * Devuelve la única instancia de JDBC ConnectionManager. Si la instancia aún no existe,
